...
//	int insertWarehouse(@Param("warehouse_id") int warehouse_id, @Param("warehouse_name") String warehouse_name,
...
//	int updateWarehouse(@Param("warehouse_id") int warehouse_id, @Param("warehouse_name") String warehouse_name,
//					    @Param("warehouse_address") String warehouse_address);
//
//	//データ削除
